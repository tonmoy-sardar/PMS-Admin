...
public class JobAllotedByListAdapter extends RecyclerView.Adapter<JobAllotedByListAdapter.ViewHolder> {
    ...
    public JobAllotedByListAdapter(FragmentActivity activity, ArrayList<JSONObject> arrayList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        try {
            holder.tv_external_user_name.setText(arrayList.get(position).getJSONObject("mmr_user").getString("employee_name"));
