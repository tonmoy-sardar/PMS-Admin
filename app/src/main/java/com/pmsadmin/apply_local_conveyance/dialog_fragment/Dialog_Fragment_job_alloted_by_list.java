...
import com.pmsadmin.apply_local_conveyance.adapter.JobAllotedByListAdapter;
...
public class Dialog_Fragment_job_alloted_by_list extends DialogFragment implements JobAllotedByListAdapter.OnItemClickListener {
    ...
    JobAllotedByListAdapter jobAllotedByListAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        jobAllotedByListAdapter = new JobAllotedByListAdapter(getActivity(), arrayList);
        jobAllotedByListAdapter.setOnItemClickListener(this);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getActivity());
        rv_project_list.setLayoutManager(layoutManager);
        rv_project_list.setHasFixedSize(true);
        rv_project_list.setAdapter(jobAllotedByListAdapter);
