...
public class CameraGalleryDialogueSitePhotosDetails extends AppCompatDialog {
    ...
    public CameraGalleryDialogueSitePhotosDetails(Activity mActivity, OnImageSet onImageSet, String choose) {
        super(mActivity);
    ...
    private void initView(View view) {
        ...
        tv_openGallery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (choose.equals("0")) {
                    ((SitePhotoDetailsActivity) mActivity).choiceMedia(ForgotPasswordActivity.GALLERY, onImageSet);
                }else{
        ...
        tv_openCamera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (choose.equals("0")) {
                    ((SitePhotoDetailsActivity) mActivity).choiceMedia(ForgotPasswordActivity.CAMERA, onImageSet);
                }else{
