...
public class AssignedCrusherDocListAdapter extends RecyclerView.Adapter<AssignedCrusherDocListAdapter.ViewHolder> {

    Context context;
    ArrayList<JSONObject> arrayList = new ArrayList<JSONObject>();


    public AssignedCrusherDocListAdapter(Context context, ArrayList<JSONObject> arrayList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.child_crusher_documents_list, parent, false);
