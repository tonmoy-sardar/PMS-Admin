...
public class EstablishmentDetails extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view = View.inflate(this, R.layout.activity_establishment_details, null);
        addContentView(view);
        ...
        rv_establishment_document_list = findViewById(R.id.rv_establishment_document_list);
        tv_add_documents = findViewById(R.id.tv_add_documents);
        rv_establishment_document_list.setNestedScrollingEnabled(false);
        ...
        try {
            ...
            arrayList_documents = (ArrayList<Result>) bundle.getSerializable("establishment_document_details");
