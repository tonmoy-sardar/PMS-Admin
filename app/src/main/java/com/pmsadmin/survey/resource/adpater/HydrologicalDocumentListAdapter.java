...
public class HydrologicalDocumentListAdapter extends RecyclerView.Adapter<HydrologicalDocumentListAdapter.ViewHolder> {

    Context context;
    ArrayList<JSONObject> arrayList = new ArrayList<JSONObject>();

    public HydrologicalDocumentListAdapter(HydrologicalDetails context, ArrayList<JSONObject> arrayList) {
